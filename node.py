...
def exclusive_on(where):
    ...
    while mempool_busy == 1 and mempool_busy_timeout < 200:
        app_log.info("Client: Waiting for database to become available, timeout in " + str(200 / 10 - mempool_busy_timeout / 10) + " seconds")
            ...
            try:
                ...
                if data == "mytxhash___":
                    ...
                    try:
                        ...
                        app_log.info(
                            "Node: Client is at block " + str(txhash_client_block))  # now check if we have any newer
            ...
            while True:
                ...
                if data == "mytxhash___":
                    ...
                    try:
                        ...
                        app_log.info(
                            "Client: Node is at block " + str(txhash_client_block))  # now check if we have any newer
