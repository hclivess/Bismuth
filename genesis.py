...
if os.path.isfile("static/ledger.db") is True:
    ...
    try:
        ...
        c.execute("INSERT INTO transactions VALUES (?,?,?,?,?,?,?,?,?,?,?,?)", ("1", timestamp, 'genesis', address, '0', str(signature_enc), public_key_readable, block_hash, 0, 1, 0, 'genesis'))  # Insert a row of data
