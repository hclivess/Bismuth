...
# NOTE: the node once carried a decentralized-apps (RISC-V) contract VM behind a second activation
# height. It was never activated and has been REMOVED. `vm:` operations, if any appear, are stored as
# ordinary inert transaction data and never execute.
