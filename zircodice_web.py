...
class index:
    def GET(self):
        ...
        html = "<!DOCTYPE html>" \
               ...
               "<p>Please send any amount of coins lower than 100 to the address <strong>"+address+"</strong> and include the word '<strong>even</strong>' or '<strong>odd</strong>' in the OpenField data.<br> You are betting on the last number in the block hash where your bet is included. 0 is considered an even number.<br>If you win, you will receive 2x your bet.</p>" \
               "<br>" \
               "<h1>Bets</h1>" \
